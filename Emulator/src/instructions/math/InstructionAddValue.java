...
public class InstructionAddValue extends Instruction {

    public InstructionAddValue(Emulator emulator, byte register, byte dataHigh, byte dataLow) {
        super(emulator, InstructionManager.OPCODE_ADD_VALUE, register, dataHigh, dataLow);
    }
