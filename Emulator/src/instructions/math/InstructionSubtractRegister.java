...
public class InstructionSubtractRegister extends Instruction {

    public InstructionSubtractRegister(Emulator emulator, byte register, byte dataHigh, byte dataLow) {
        super(emulator, InstructionManager.OPCODE_SUBTRACT_REGISTER, register, dataHigh, dataLow);
    }
