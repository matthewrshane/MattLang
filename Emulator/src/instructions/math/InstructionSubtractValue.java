...
public class InstructionSubtractValue extends Instruction {

    public InstructionSubtractValue(Emulator emulator, byte register, byte dataHigh, byte dataLow) {
        super(emulator, InstructionManager.OPCODE_SUBTRACT_VALUE, register, dataHigh, dataLow);
    }
