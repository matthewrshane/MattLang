...
public class InstructionMultiplyRegister extends Instruction {

    public InstructionMultiplyRegister(Emulator emulator, byte register, byte dataHigh, byte dataLow) {
        super(emulator, InstructionManager.OPCODE_MULTIPLY_REGISTER, register, dataHigh, dataLow);
    }
